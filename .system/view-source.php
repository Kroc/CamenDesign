...
//==============================================================================
// PHP view-source: whilst the .htaccess should show the PHP as text/plain
// (and does on my localhost), my live server is running PHP as a CGI-module
// and as such the .htaccess rules don’t work. here we simply print the
// requested code to screen
